...
estimate_theta_qml <- function(y_t, initial_guess, beta) {
  result <- optim(par = initial_guess, fn = qml_log_likelihood, y_t = y_t, beta=beta, method = "L-BFGS-B", lower = c(-0.9, 0.1), upper = c(0.9, 1))
...
model {
  ...
  sigma_sq ~ dunif(0, 2)  # Variance du bruit eta
